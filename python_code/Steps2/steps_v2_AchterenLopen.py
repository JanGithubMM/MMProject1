...
voorbeeld1 = pygame.image.load("/home/pi/Documents/Oefeningen/8a_achteruit_lopen_zonder.png")        #aanpasbare afbeelding
voorbeeld1 = pygame.transform.smoothscale(voorbeeld1, (int(screen_w/100)*14, int(screen_w/100)*20))
voorbeeld2 = pygame.image.load("/home/pi/Documents/Oefeningen/8b_achteruit_lopen_zonder.png")        #aanpasbare afbeelding
...
#audio
audio1 = pygame.mixer.Sound("/home/pi/Documents/Audio/leun_naar_achter.wav")               #aanpasbare audio
audio2 = pygame.mixer.Sound("/home/pi/Documents/Audio/leun_naar_voren.wav")                #aanpasbare audio
...
while True:
        ...
        #pygame.draw.rect(screen,(255,255,255),(0,0,x,screen_h),0) #zwarte balk
        screen.blit(photo, (x, screen_h/2 - photo.get_height()/2), area=[x,0,x+xStep,photo.get_height()])
	#screen.blit(uitvoeringText, (screen_w-uitvoeringText.get_width(), screen_h-(screen_h/22)-uitvoeringText.get_height())) #de uitvoeringstekst
        pygame.display.flip()
        time.sleep(0.01)
